...
class Trainer() :
    def __init__ (self, cnn, criterion, optimizer, device, args) :
        self.model = cnn
...
if __name__ == "__main__" :
    ...
    parser.add_argument("--TRAINING_HEAD", type=str, default='head1')
    ...
    parser.add_argument("--OUTPUT", type=str, default='./ckpt/each_head/lossWeight-auged-effiv2s')
    parser.add_argument("--LOG", type=str, default='./tensorboard/each_head/1/lossWeight-auged-effiv2s')
    ...
    cnn = CNN(model_name=args.MODEL_NAME,
              ...
              head_name=args.TRAINING_HEAD).to("cuda")
    ...
    trainer = Trainer(cnn, criterion, optimizer, device, args)
