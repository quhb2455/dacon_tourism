...
class Trainer() :
    def __init__ (self, mask_cnn, cnn, criterion, optimizer, device, args) :
        # setup for masking
        self.mask_cnn = mask_cnn
    ...
    def training(self, epoch):
        ...
        for batch, (img, label1, label2, label3) in enumerate(tqdm_train, start=1):
            ...
            if self.APPLY_MIXUP :
                ...
                # create mask
                mask_pred = self.mask_cnn(img)
                mask = self.cls_weight_generator(mask_pred, num=18, category=1)
...
if __name__ == "__main__" :
    ...
    parser.add_argument("--TRAINING_HEAD", type=str, default='head2')
    ...
    parser.add_argument("--OUTPUT", type=str, default='./ckpt/each_head/2/head1mask-lossWeight-auged-effiv2s')
    parser.add_argument("--LOG", type=str, default='./tensorboard/each_head/2/head1mask-lossWeight-auged-effiv2s')
    ...
    trainer = Trainer(head1_cnn, cnn, criterion, optimizer, device, args)
